                    ...
                    .forEach(filePath ->{
                        ...
                        County county = countyRepository.findByName(countyName).orElse(countyRepository.save(new County(countyName)));
                            ...
                            try {
                                ...
                                List<Institution> institutions = new ArrayList<>(townHalls.stream().map(townHallDto -> {
                                ...
                                drpciv.setAddress(countyName);
                                drpciv.setCounty(county);
                                ...
                                anaf.setName("ANAF");
                                anaf.setAddress(countyName);
                                anaf.setCounty(county);
                                ...
                                anpc.setName("ANPC");
                                anpc.setAddress(countyName);
                                anpc.setCounty(county);
